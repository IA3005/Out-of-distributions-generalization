...
class CVAE1(nn.Module):
	...
	def loss(self, rec_x, x, mu, logVar):
		...
		BCE = F.binary_cross_entropy(rec_x, x, size_average=False)  #not averaged over mini-batch if size_average=FALSE 
